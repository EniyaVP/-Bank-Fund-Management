...
class Cuddalore_Branch(Tamil_Nadu_Bank):
    ...
    def Bl_Cdlr(self, AN):
        ...
        try:
            ...
            print("-----------------------------------------------------------")
a1=open(r"C:\Users\eniya\OneDrive\Documents\python project.py","w+")
class Trichy_Branch(Tamil_Nadu_Bank):
    ...
    def Bl_Tri(self,AN):
        try:
            ...
            print("BALANCE AMOUNT: ", self.data[AN])
            print("-----------------------------------------------------------")
a2=open(r"C:\Users\eniya\OneDrive\Documents\python project.py","w+")
...
# trichy
b=open(r"C:\Users\eniya\OneDrive\Documents\python project.py","r+")
# b = open(r"C:\Users\eniya\OneDrive\Documents\python project.py","r+")
...
# #chennai
b1=open(r"C:\Users\eniya\OneDrive\Documents\python project.py","r+")
# # b = open(r"C:\Users\eniya\OneDrive\Documents\python project.py","r+")
